...
import 'package:time_tracker_flutter_app/app/sign_in/email_sign_in_change_model.dart';
...
class _EmailSignInFormChangeNotifierState
  ...
  Future<void> _submit() async {
    ...
    try{
      ///widget.block because we are in _EmailSignInFormBlocBasedState class
      /// not in EmailSignInFormBlocBased class
      await model.submit();
